...
GPIO.setmode(GPIO.BOARD) #Can choose either BCM or BOARD
GPIO.cleanup()
...
awshost = "xxxxxxxxx.xxxxxxxxxxxxxxx.amazonaws.com"   # Endpoint
awsport = 8883                                               # Port no.   
clientId = "XXXXXXXXXXX"                                     # Thing_Name
thingName = "XXXXXXXXXX"                                    # Thing_Name
caPath = "/home/XXXXX/XXX/root-CA.crt"                                      # Root_CA_Certificate_Name
certPath = "/home/XXXXX/XXX/ProjectOne.cert.pem"                            # <Thing_Name>.cert.pem
keyPath = "/home/XXXXX/XXX/ProjectOne.private.key"                          # <Thing_Name>.private.key
...
while 1==1:
	...
	if result.is_valid():
		tempreading = result.temperature                        # Connecting Temperature Readings 
